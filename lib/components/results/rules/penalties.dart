                    ...
                    child: Card(
                      ...
                      child: Row(
                        children: [
                          ...
                          Flexible(
                            fit: FlexFit.tight,  // 端まで拡張する
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget> [
                                Padding(
                                  padding: const EdgeInsets.only(top: AppNum.xs, bottom: AppNum.xs),
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(
                                        data.englishName,
                                        style: const TextStyle(
                                            fontSize: AppNum.resultsNameFontSize * 0.9
                                        ),
                                      ),
                                      // 日本語名
                                      Text(
                                ...
                                // 反則のフラグ用チップ
                                Padding(
                                  padding: const EdgeInsets.only(top: AppNum.xs, bottom: AppNum.xs, left: AppNum.sm, right: AppNum.sm),
                                  child: Row(
                                    children: [
                                      // 右寄せにするために挿入
